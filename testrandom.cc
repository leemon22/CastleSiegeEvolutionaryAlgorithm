...
int main() {
  ...
  for (int funcid = 1; funcid <= 30; funcid++) {
    ...
    cerr << "Warning: output by console, if you want to create the output file "
            "you have to comment cec17_print_output()"
         << endl;
    ...
    cout << "Best Random[F" << funcid << "]: " << scientific
         << cec17_error(best) << endl;
  }
}
